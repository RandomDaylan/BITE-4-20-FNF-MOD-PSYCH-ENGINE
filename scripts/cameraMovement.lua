...
function onUpdate()
    if getSongPosition() >= 45770 then
        followchars = true;
    end
    if getSongPosition() >= 54860 then
        followchars = false;
    end
    if getSongPosition() >= 91710 then
        followchars = true;
    end
    if getSongPosition() >= 109700 then
        followchars = false;
    end
    if getSongPosition() >= 137140 then
        followchars = true;
    end
    if getSongPosition() >= 146280 then
        followchars = false;
    end
end
